...
def main():
    ...
    model = cnnModel2(inputChannel, inputSize, numClassess).to(device)
    ...
    torch.save(model, f'model3_CNN2_{datasetName}.pt')
    modelScripted = torch.jit.script(model)
    modelScripted.save(f'model3_CNN2_Scripted_{datasetName}.pt')
