...
class cnnModel6(tNN.Module):
    def __init__(self, inputChannel, inputSize, numClassess):
        ...
        self.fc1 = tNN.Linear(self.inputSize, 256)
        self.fc2 = tNN.Linear(256, 256)
        self.fc3 = tNN.Linear(256, 256)
        self.fc4 = tNN.Linear(256, numClassess)
...
def main():
    ...
    model = cnnModel6(inputChannel, inputSize, numClassess).to(device)
    ...
    torch.save(model, f'model7_CNN6_{datasetName}.pt')
    modelScripted = torch.jit.script(model)
    modelScripted.save(f'model7_CNN6_Scripted_{datasetName}.pt')
